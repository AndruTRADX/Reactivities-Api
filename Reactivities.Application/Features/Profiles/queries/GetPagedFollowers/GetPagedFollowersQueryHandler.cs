...
public class GetPagedFollowersQueryHandler(IMapper mapper, IUnitOfWork unitOfWork, IUserAccessor userAccessor, IFollowStatsEnricher followStatsEnricher) : IRequestHandler<GetPagedFollowersQuery, ApiResponse<PagedResponse<UserProfileResponse>>>
{
