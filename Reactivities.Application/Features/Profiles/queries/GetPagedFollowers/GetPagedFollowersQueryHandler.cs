...
public class GetPagedFollowersQueryHandler(IMapper mapper, IUnitOfWork unitOfWork) : IRequestHandler<GetPagedFollowersQuery, ApiResponse<PagedResponse<UserProfileResponse>>>
{
